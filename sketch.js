...
function preload() {
  bg1 = loadImage("backgroundImg/el.webp");
  bg2 = loadImage("backgroundImg/lion.webp");
  bg3 = loadImage("backgroundImg/panda.webp");
  bg4 = loadImage("backgroundImg/monkey.webp");
  bg5 = loadImage("backgroundImg/giraffe.webp");
  bg6 = loadImage("backgroundImg/pig.webp");
}
